...
const Sidebar = () => {
  ...
  const avatarUrl =
    user?.photoUrl || `https://ui-avatars.com/api?name=${encodeURIComponent(user?.name || "User")}`;

  return (
    <aside className="flex flex-col w-full max-w-xs min-h-screen px-4 py-8 overflow-y-auto bg-white border-r shadow-sm">
      <div className="flex flex-col items-center mt-4">
        ...
        />
        <h4 className="mt-3 text-lg font-semibold text-gray-900 truncate">
          {user?.name || "User"}
        </h4>
