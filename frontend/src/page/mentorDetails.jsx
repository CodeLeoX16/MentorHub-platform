    ...
    <Layout>
      <div className="max-w-6xl p-4 mx-auto md:p-8">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {/* Mentor's Profile */}
          <div className="col-span-1 p-6 bg-white rounded-xl shadow-sm border">
            {mentorLoading ? (
              ...
              <>
                ...
                <h3 className="mt-8 text-lg font-semibold text-center text-gray-900">
                  Connect with me
                </h3>
                <div className="flex justify-center mt-4 space-x-4 text-gray-700">
                  <a
                    href={
          ...
          {/* Mentor's Services */}
          <div className="col-span-2 p-6 bg-[#F5F5F5] rounded-xl shadow-sm border">
            <h3 className="mb-4 text-2xl font-bold text-gray-900">Book a Session</h3>
            ...
            {servicesLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-gray-700">
                <BiErrorAlt className="w-20 h-20 mb-4 text-blue-500" />
