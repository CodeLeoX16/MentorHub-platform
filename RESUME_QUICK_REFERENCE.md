# MentorHub Platform - Quick Resume Reference

## Project One-Liner
**MentorHub Platform** | Full-stack MERN application for connecting mentors and mentees with payment processing, automated scheduling, and email notifications | [Live Demo](https://mentorhub-platform-frontend2.onrender.com)
...
- Integrated Razorpay webhooks for payment confirmation, Zoom API for automated meeting creation, and Nodemailer with EJS templates for transactional emails
- Implemented JWT authentication with bcrypt encryption, role-based access control, and custom error handling middleware for secure multi-role platform

### Option C: Frontend-Focused (Best for Frontend Roles)
- Developed responsive React 18 SPA with React Router, React Hook Form, and Zustand state management, integrating Ant Design and Tailwind CSS for modern UI
- Built reusable component library with custom hooks for API integration, form validation, and error handling, ensuring cross-device compatibility
...
**Frontend:** React, React Router, Ant Design, Tailwind CSS, Zustand, Axios, React Hook Form

**Backend:** Node.js, Express.js, MongoDB, Mongoose, JWT, Joi, Nodemailer

**APIs & Services:** Razorpay, Zoom API, Cloudinary, SMTP/Email

**Tools:** Git, GitHub, npm, Render (deployment)

**Concepts:** RESTful APIs, Authentication/Authorization, Payment Integration, Responsive Design, Full-Stack Development
...
1. **Architecture Decision:** Chose MERN stack for rapid development and MongoDB for flexible schema
2. **Challenge Solved:** Integrated 4 third-party APIs (Razorpay, Zoom, Cloudinary, Nodemailer) with proper error handling
3. **Security Implementation:** JWT with refresh tokens, bcrypt hashing, environment variables, CORS
4. **Performance:** Optimized MongoDB queries with proper indexing, lazy loading for images
5. **User Experience:** Responsive design with Ant Design, intuitive booking flow, real-time notifications
6. **Deployment:** Configured environment-based settings for dev/prod, deployed to Render with CI/CD
...
- **GitHub:** https://github.com/CodeLeoX16/MentorHub-platform
- **Author:** Harshad Birajdar (CodeLeoX16)
